...
<br><br>
`setTimeout()` - метод, который устанавливает таймер и выполняет функцию или указанный фрагмент кода по истечении времени таймера. [Документация метода](https://developer.mozilla.org/en-US/docs/Web/API/Window/setTimeout).
...
```
### Получилось:
![image](https://github.com/user-attachments/assets/fb531845-5547-4388-b33e-9a5354812571)
